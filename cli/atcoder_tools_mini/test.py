...
def run_tests(args):
    ...
    if not os.path.isdir(in_dir) or not os.path.isdir(out_dir):
        print(f"[CLI] \033[91mError: Directory '{in_dir}' or '{out_dir}' not found.\033[0m")
        print("[CLI] \033[91mAre you in the task directory (e.g. abc443/A) generated by 'atm gen'?\033[0m")
        return False
